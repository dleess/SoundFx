...
**골 완료** (2026-08-09) — 마일스톤 1~4 구현·자동 검증·사용자 청감 검증 전부 통과.

- 필수 검증 `node --test`: 26/26 통과
- 실곡 측정: 윤도현-사랑했나봐(-26.5dBFS) vs 란-어쩌다가(-11.1dBFS), 원본 15.4dB 차이 → 출력 -25.2/-25.0dBFS, 0.2dB 차이
- 사용자가 본인 Chrome에 로드해 직접 청취 확인 ("잘 되네")
- 다음 골 후보: 2단계 Safari 포팅(macOS/iOS), 3단계 Android 앱 (plan.md 참조)
